...
public class KingPig extends Enemy {
    ...
    public KingPig(float x, float y, int width, int height) {
        super(x, y, width, height, KINGPIG);
        initHitBox(28, 30);
        initAttackBox();
        initValue();
    ...
    public void render(Graphics g, int xLvlOffset, int yLvlOffset) {
        if (active) {
            g.drawImage(aniKingPig[state][aniIndex], (int) (hitBox.x - xLvlOffset - xOffset - flipX()), (int) (hitBox.y - yLvlOffset - yOffset), (int) (width * Game.SCALE * flipW()), (int) (height * Game.SCALE), null);
        }
    }
}
